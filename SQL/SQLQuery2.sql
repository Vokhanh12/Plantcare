...
SELECT 'Admin',PWDENCRYPT('Admin@123')

--Isernt into Application forManager
Insert Into APPLICATION_USER
SELECT 'khanh1803',PWDENCRYPT('Khanh1803@2002')

Insert Into APPLICATION_USER
SELECT 'vinh123',PWDENCRYPT('Vinh123@2002')

--Insert into Application for Employee
Insert Into APPLICATION_USER
SELECT 'Nv02',PWDENCRYPT('Nv02@123')

Insert Into APPLICATION_USER
SELECT 'Nv03',PWDENCRYPT('Nv03@123')

--Insert into Data for DATA_APPLICATION_FOR_ADMIN

SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_ADMIN ON
INSERT INTO dbo.DATA_APPLICATION_FOR_ADMIN (ID,MaAD,TenAD,UserName,UserPassword,NGAY_DANG_NHAP)
SELECT APPLICATION_USER.ID,'AD01','ADMIN01', APPLICATION_USER.UserName, APPLICATION_USER.UserPassword,'12/21/2022'
...
INSERT INTO dbo.DATA_APPLICATION_FOR_MANAGER (ID,MaQL,TenQL,UserName,UserPassword,NGAY_DANG_NHAP)
SELECT APPLICATION_USER.ID,'QL01','NGUYEN VO KHANH', APPLICATION_USER.UserName, APPLICATION_USER.UserPassword,'12/21/2022'
FROM APPLICATION_USER 
...
SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_MANAGER ON
INSERT INTO dbo.DATA_APPLICATION_FOR_MANAGER (ID,MaQL,TenQL,UserName,UserPassword,NGAY_DANG_NHAP)
SELECT APPLICATION_USER.ID,'QL02','NGUYEN THANH VINH', APPLICATION_USER.UserName, APPLICATION_USER.UserPassword,'12/21/2022'
FROM APPLICATION_USER 
...
INSERT INTO dbo.DATA_APPLICATION_FOR_EMPLOYEE (ID,MaNV,TenNV,UserName,UserPassword,NGAY_DANG_NHAP)
SELECT APPLICATION_USER.ID,'NV02','TRAN VO LOC', APPLICATION_USER.UserName, APPLICATION_USER.UserPassword,'12/21/2022'
FROM APPLICATION_USER 
...
SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_EMPLOYEE ON
INSERT INTO dbo.DATA_APPLICATION_FOR_EMPLOYEE (ID,MaNV,TenNV,UserName,UserPassword,NGAY_DANG_NHAP)
SELECT APPLICATION_USER.ID,'NV03','LE PHU KHAI', APPLICATION_USER.UserName, APPLICATION_USER.UserPassword,'12/21/2022'
FROM APPLICATION_USER 

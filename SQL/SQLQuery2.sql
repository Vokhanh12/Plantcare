...
Insert Into dbo.DATA_APPLICATION_REGISTER
SELECT 'Nv02',PWDENCRYPT('Nv02@123'),'TRAN','LOC','nv02@gmail.com',(SELECT NGAYSINH FROM NHANVIEN WHERE TENNV='TRAN VO LOC'),'12/25/2022'

Insert Into dbo.DATA_APPLICATION_REGISTER
SELECT 'Nv03',PWDENCRYPT('Nv03@123'),'LE','KHAI','nv03@gmail.com',(SELECT NGAYSINH FROM NHANVIEN WHERE TENNV='LE PHU KHAI'),'12/25/2022'
...
SELECT DATA_APPLICATION_USER.ID,'QL01','NGUYEN VO KHANH', DATA_APPLICATION_USER.UserName, DATA_APPLICATION_USER.UserPassword,'NGUYEN','KHANH','khanhyou2018@gmail.com',MANAGER.SDT_MANAGER,DATA_APPLICATION_USER.TAI_KHOANG,'12/21/2022'
FROM DATA_APPLICATION_USER,MANAGER
WHERE DATA_APPLICATION_USER.ID=2 AND MANAGER.TENQL='NGUYEN VO KHANH';
...
SELECT DATA_APPLICATION_USER.ID,'NV02','TRAN VO LOC', DATA_APPLICATION_USER.UserName, DATA_APPLICATION_USER.UserPassword,'TRAN','LOC','locnv01@gmail.com',NHANVIEN.SDT_EMPLOYEE,DATA_APPLICATION_USER.TAI_KHOANG,'12/21/2022'
FROM DATA_APPLICATION_USER,NHANVIEN
WHERE DATA_APPLICATION_USER.ID=4 AND NHANVIEN.TENNV='TRAN VO LOC';
SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_EMPLOYEE OFF 

SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_EMPLOYEE ON
INSERT INTO dbo.DATA_APPLICATION_FOR_EMPLOYEE (ID,MaNV,TenNV,UserName,UserPassword,FristName,LastName,EmailAdress,SDT_EMPLOYEE,TAI_KHOANG,NGAY_DANG_KY)
SELECT DATA_APPLICATION_USER.ID,'NV03','LE PHU KHAI', DATA_APPLICATION_USER.UserName, DATA_APPLICATION_USER.UserPassword,'LE','KHAI','khainv02@gmail.com',NHANVIEN.SDT_EMPLOYEE,DATA_APPLICATION_USER.TAI_KHOANG,'12/21/2022'
FROM DATA_APPLICATION_USER,NHANVIEN
WHERE DATA_APPLICATION_USER.ID=5 AND NHANVIEN.TENNV='LE PHU KHAI';
SET IDENTITY_INSERT dbo.DATA_APPLICATION_FOR_EMPLOYEE OFF 
